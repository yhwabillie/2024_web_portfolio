      ...
      <div className="flex-1 flex items-center my-50 mx-auto">
        <div className="w-300 min-h-600 xs:w-375 md:min-w-600 box-border text-black bg-white p-30 rounded-md shadow-xl">
          <button onClick={handleResetModal} className="block ml-auto">
            ...
            <IoIosCloseCircleOutline className="text-40 text-[#333]" />
          </button>
          <h3 className="text-center block mb-30">
            <span className="block text-20 tracking-tighter text-[#999]">Skill Set</span>
            <span className="block text-25 tracking-tighter font-[600]">저는 이런 작업을 수행할 수 있습니다.</span>
          </h3>
            ...
            <div className="mb-20">
              ...
              <div className="pl-14">
                <div className="mb-10">
                  ...
                  <p className="tracking-tighter pl-20">react-hook-form 라이브러리를 사용한 인풋 데이터의 validation 및 관련 UI 컨트롤</p>
                </div>
                <div className="mb-10">
                  <strong className="font-[600] tracking-tighter">02) Context API, Recoil, Zustand</strong>
                  <p className="tracking-tighter pl-20">
                ...
                <div className="mb-10">
                  ...
                  <p className="tracking-tighter pl-20">로컬스토리지를 활용하여 필요한 데이터를 저장, 가져와서 활용 및 삭제</p>
                </div>
                <div className="mb-10">
                  <strong className="font-[600] tracking-tighter">03) 국제화</strong>
                  <p className="tracking-tighter pl-20">next-intl 라이브러리를 활용한 NextJS 프로젝트 국제화 작업 (한국어/일본어)</p>
                </div>
                <div className="mb-10">
                  <strong className="font-[600] tracking-tighter">04) SEO (Google Search에 인덱싱되기위한 기술적인 SEO 작업)</strong>
                  <p className="tracking-tighter leading-1.6 pl-20">
                    NextJS 환경에서 루트 layout.tsx의 metadata 객체에 필요한 속성 작성, 하위 경로 상속 및 template을 활용한 타이틀 포멧 적용
                  </p>
                  <p className="tracking-tighter leading-1.6 pl-20">metadata 다국어 적용</p>
                  <p className="tracking-tighter leading-1.6 pl-20">sitemap.xml에 필요한 경로들을 빌드시점에 루트에 생성</p>
                  <p className="tracking-tighter leading-1.6 pl-20">Google Lighthouse를 사용하여 웹 최적화 점수 확인 및 피드백</p>
                </div>
                <div className="mb-10">
            ...
            <div className="mb-20">
              ...
              <div className="pl-14">
                <div className="mb-10">
                  ...
                  <p className="tracking-tighter pl-15">코드 가독성과 웹 표준, 웹 접근성을 준수하기위한 시멘틱 마크업 작업</p>
                </div>
                <div className="mb-10">
                  <strong className="font-[600] tracking-tighter">02) 크로스 브라우징 작업</strong>
                  <p className="tracking-tighter pl-15">Chrome, Edge, Safari, Firefox의 브라우저 화면을 고려한 퍼블리싱</p>
                </div>
                <div className="mb-10">
                  <strong className="font-[600] tracking-tighter">03) 유틸리티 퍼스트 CSS 프레임워크 활용</strong>
                  <p className="tracking-tighter pl-15">
                ...
                <div className="mb-10">
                  ...
                  <p className="tracking-tighter pl-15">
                    apexchart.js 와 plotly.js를 활용하여 백엔드에서 데이터를 받아 다양한 그래프로 표현 및 디자인에 맞는 차트 라이브러리 커스텀 작업
                  </p>
                </div>
                <div className="mb-10">
                  <strong className="font-[600] tracking-tighter">06) 인터랙티브 웹 애니메이션 구현</strong>
                  <p className="tracking-tighter pl-15">
                    GSAP, Framer Motion, React-Spring과 같은 애니메이션 라이브러리를 이용하여 인터랙티브 스크롤 애니메이션 구축
                  </p>
                </div>
              </div>
            </div>
          ...
          <button className="block mt-30 text-18 tracking-tighter bg-blue-3 text-white py-15 px-30 w-full rounded-xxs">
            관련 작업 및 프로젝트 보러가기
          </button>
        </div>
      </div>
